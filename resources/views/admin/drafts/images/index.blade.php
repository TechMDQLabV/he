...
<div class="main main-raised">
    <div class="container">
        <div class="section text-center">
            <h2 class="title">Imágenes del producto "{{ $draft->title }}"</h2>

            <form method="post" action="" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="file" name="photo" required>    
                <button type="submit" class="btn btn-warning btn-round t-black">Subir nueva imagen</button>
                <a href="{{ url('/admin/drafts') }}" class="btn btn-warning btn-round t-black">Volver al listado de proyectos</a>
            </form>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-body">
                        ...
                        <form method="post" action="">
                            ...
                            @else
                                <a href="{{ url('/admin/drafts/'.$draft->id.'/images/select/'.$image->id) }}" class="btn btn-primary btn-fab btn-fab-mini btn-round">
                                    <i class="material-icons">favorite</i>
                                </a>
                            @endif
                        </form>
